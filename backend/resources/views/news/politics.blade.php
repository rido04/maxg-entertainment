...
<div class="min-h-screen bg-gray-50">
    <div class="max-w-6xl mx-auto px-4 py-8">
        ...
        <div class="mb-8">
            ...
            <h1 class="text-4xl font-bold text-gray-900 mb-2">Politics</h1>
            <p class="text-gray-600">Latest political news and updates</p>
        </div>
                    ...
                    <article class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
                        <a href="{{ route('news.show', $article->slug) }}" class="block">
                            ...
                            <div class="p-6">
                                <!-- Category Badge -->
                                <div class="mb-3">
                                    <span class="inline-block px-3 py-1 text-xs font-semibold text-red-600 bg-red-100 rounded-full uppercase">
                                        Politics
                                    </span>
                                </div>
        ...
        @else
            ...
            <div class="text-center py-12">
                ...
                <h3 class="text-lg font-medium text-gray-900 mb-2">No politics articles found</h3>
                <p class="text-gray-600">There are no politics articles available at the moment.</p>
